...
from contrast_models.nnunetv2_swin_umamba.utilities.plans_handling.plans_handler import ConfigurationManager, PlansManager
...
class SwinUMamba(nn.Module):
    ...
    def forward(self, x_in):
        ...
        #     print(f'ds:{self.deep_supervision}')
...
def load_pretrained_ckpt(
    model, 
    ckpt_path="/mnt/workspace/AgileFormer/vssmtiny_dp01_ckpt_epoch_292.pth"
):
...
def Rolling_Unet_S(num_classes=1,input_channels=3,
