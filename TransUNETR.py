...
class PatchMerging(nn.Module):
    ...
    def __init__(self, input_resolution, input_dim, ratio=4.0):
        super().__init__()
        self.input_resolution = input_resolution
        self.dim = input_dim
...
#####需要测试一下，这个可变性卷积是否有作用，还需要测试瓶颈层是否有用，还需要测试SPPF是否有作用
...
class Rolling_Unet_S(nn.Module):
    def __init__(self,num_classes, input_channels=3, 
        ...
        ###HATB1
        self.psa_mlla_block3=PSA_MLLABlock(embed_dims[2],embed_dims[3],
        ...
        ###HATB2
        self.psa_mlla_block3_up=PSA_MLLABlock(embed_dims[3],embed_dims[2],
    ...
    def forward(self, x):
        ...
        x_steam=self.deform_pos(x_steam) ###对MSPF的作用进行探索
