...
import sys
sys.path.append('/mnt/workspace/Rolling-Unet-free-isic/')
from contrast_models.merit_lib.decoders import CASCADE_Add, CASCADE_Cat

from contrast_models.merit_lib.maxxvit_4out import maxvit_tiny_rw_224 as maxvit_tiny_rw_224_4out
from contrast_models.merit_lib.maxxvit_4out import maxvit_rmlp_tiny_rw_256 as maxvit_rmlp_tiny_rw_256_4out
from contrast_models.merit_lib.maxxvit_4out import maxxvit_rmlp_small_rw_256 as maxxvit_rmlp_small_rw_256_4out
from contrast_models.merit_lib.maxxvit_4out import maxvit_rmlp_small_rw_224 as maxvit_rmlp_small_rw_224_4out
...
def load_pretrained_weights(img_size, model_scale):
    ...
    if(model_scale=='tiny'):
        if img_size==224:
            ...
            print('Loading:', '/mnt/workspace/AgileFormer/maxvit_tiny_rw_224_sw-7d0dffeb.pth')
            state_dict = torch.load('/mnt/workspace/AgileFormer/maxvit_tiny_rw_224_sw-7d0dffeb.pth')
        elif(img_size==256):
            backbone = maxvit_rmlp_tiny_rw_256_4out()
            print('Loading:', '/mnt/workspace/AgileFormer/maxvit_rmlp_tiny_rw_256_sw-bbef0ff5.pth')
            state_dict = torch.load('/mnt/workspace/AgileFormer/maxvit_rmlp_tiny_rw_256_sw-bbef0ff5.pth')
        else:
        ...
        if img_size==224:
            ...
            print('Loading:', '/mnt/workspace/AgileFormer/maxvit_rmlp_small_rw_224_sw-6ef0ae4f.pth')
            state_dict = torch.load('/mnt/workspace/AgileFormer/maxvit_rmlp_small_rw_224_sw-6ef0ae4f.pth')
        elif(img_size==256):
            backbone = maxxvit_rmlp_small_rw_256_4out()
            print('Loading:', '/mnt/workspace/AgileFormer/maxxvit_rmlp_small_rw_256_sw-37e217ff.pth')
            state_dict = torch.load('/mnt/workspace/AgileFormer/maxxvit_rmlp_small_rw_256_sw-37e217ff.pth')
        else:
            sys.exit(str(img_size)+" is not a valid image size! Currently supported image sizes are 224 and 256.")
    else:
    ...
    def __init__(self,
     num_classes=1,input_channels=3,
                         deep_supervision=False,img_size=512,
                          img_size_s1=(256,256), img_size_s2=(224,224), model_scale='tiny', decoder_aggregation='additive', interpolation='bilinear',ds=False):
...
class MERIT_Cascaded_Small(nn.Module):
    def __init__(self, num_classes=1, img_size_s1=(256,256), img_size_s2=(224,224), decoder_aggregation='additive', interpolation='bilinear',
    ds=False):
        ...
        self.backbone2 = maxvit_rmlp_small_rw_224_4out()  # [64, 128, 320, 512]
        print('Loading:', '/mnt/workspace/AgileFormer/maxxvit_rmlp_small_rw_256_sw-37e217ff.pth')
        state_dict1 = torch.load('/mnt/workspace/AgileFormer/maxxvit_rmlp_small_rw_256_sw-37e217ff.pth')        
        self.backbone1.load_state_dict(state_dict1, strict=False)
        
        print('Loading:', '/mnt/workspace/AgileFormer/maxvit_rmlp_small_rw_224_sw-6ef0ae4f.pth')        
        state_dict2 = torch.load('/mnt/workspace/AgileFormer/maxvit_rmlp_small_rw_224_sw-6ef0ae4f.pth')
        self.backbone2.load_state_dict(state_dict2, strict=False)
...
if __name__ == '__main__':
    model = MERIT_Cascaded(num_classes=9,model_scale='tiny').cuda()
    input_tensor = torch.randn(1, 3, 352, 352).cuda()

    p4= model(input_tensor)
    print(p4.size())
