...
class Rolling_Unet_S(nn.Module):
    def __init__(
        ...
        self.FocalViT = FocalTransformer(
            img_size=img_size, in_chans=input_channels, patch_size=patch_size, 
        ...
        self.out = UnetOutBlock(
            spatial_dims=spatial_dims, in_channels=feature_size, out_channels=num_classes        )  
...
if __name__=='__main__':
    ...
    model=Rolling_Unet_S(1,3,img_size=512)
    out=model(input)
